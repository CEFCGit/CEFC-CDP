...
SELECT @load_date AS ParamIn ,
	   ...
	   sum(((([Amt_cCEFC]+[Amt_cFunding_Partner])+[Amt_cEquity_Other])+[Amt_cFunding_Grant])*l.Percent_of_Project_Amt) as Total_Funds_Mobilised_Calc,
	   sum((([Amt_cEquity_Other]+[Amt_cFunding_Partner])/nullif([Amt_cCEFC],(0)))*l.Percent_of_Project_Amt) as Private_Sector_Leverage_Calc,
	   ...
	   sum(([Concessionality_Calc]/nullif([cAssessment_Savings_TCO2_Life],(0)))*l.Percent_of_Project_Amt) as Concession_per_tCO2_Calc ,
