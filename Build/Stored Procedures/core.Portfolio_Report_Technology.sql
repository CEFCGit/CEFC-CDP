...
SELECT @load_date AS ParamIn ,
	   ...
	   sum(b.Total_Funds_Mobilised_Calc*td.Percent_of_Project_Amt) as Total_Funds_Mobilised_Calc,
	   sum(b.Private_Sector_Leverage_Calc*td.Percent_of_Project_Amt) as Private_Sector_Leverage_Calc,
	   ...
	   sum(b.Concession_per_tCO2_Calc*td.Percent_of_Project_Amt) as Concession_per_tCO2_Calc ,
