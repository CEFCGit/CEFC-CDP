...
SELECT @load_date AS ParamIn ,   
	   ...
	   p.Industry_Division,
	   p.cTechnology,
	   b.Nameplate_Generation_CapacityMW_New*l.Percent_of_Project_Amt as Nameplate_Generation_CapacityMW_New ,
	   b.Nameplate_Generation_CapacityMW_Existing*l.Percent_of_Project_Amt as Nameplate_Generation_CapacityMW_Existing,
	   ...
	   b.Amt_cCEFC*l.Percent_of_Project_Amt as Amt_cCEFC,
	   b.Amt_cFunding_3rd_Party*l.Percent_of_Project_Amt as Amt_cFunding_3rd_Party,
	   b.Amt_cFunding_Partner*l.Percent_of_Project_Amt as Amt_cFunding_Partner,
	   b.Amt_cEquity_Internal*l.Percent_of_Project_Amt as Amt_cEquity_Internal,
	   b.Amt_cEquity_Other*l.Percent_of_Project_Amt as Amt_cEquity_Other,
	   b.Amt_cFunding_Grant*l.Percent_of_Project_Amt as Amt_cFunding_Grant,
	   b.Amt_cSum_Funding_Other*l.Percent_of_Project_Amt as Amt_cSum_Funding_Other,
	   b.Total_Funds_Mobilised_Calc*l.Percent_of_Project_Amt as Total_Funds_Mobilised_Calc,
	   b.Private_Sector_Leverage_Calc*l.Percent_of_Project_Amt as Private_Sector_Leverage_Calc,
	   b.cAssessment_Savings_Annual_TCO2*l.Percent_of_Project_Amt as cAssessment_Savings_Annual_TCO2,
	   b.cAssessment_Savings_TCO2_Life*l.Percent_of_Project_Amt as cAssessment_Savings_TCO2_Life,
	   b.cAssessment_NPV_CEFC_Cost*l.Percent_of_Project_Amt as Assessment_NPV_CEFC_Cost,
	   b.cAssessment_NPV_Gov_Cost*l.Percent_of_Project_Amt as cAssessment_NPV_Gov_Cost,
	   b.Concession_flag_Calc,
	   b.Amt_cConcessionality*l.Percent_of_Project_Amt as Amt_cConcessionality,
	   b.Concession_per_tCO2_Calc*l.Percent_of_Project_Amt as Concession_per_tCO2_Calc ,
	   b.cAssessment_Credit_Risk,
	   b.Amt_cCGBR_5yr*l.Percent_of_Project_Amt as Amt_cCGBR_5yr, 
	   p.ID_Master_Project,
	   p.cMasterProject,
	   p.cStatus,
	   pd.ID_Priority,
	   ...
	   b.Amt_cCommitment*l.Percent_of_Project_Amt as Amt_cCommitment,
	   cdf.Gross_Principal*l.Percent_of_Project_Amt as Gross_Principal,
	   cdf.Capitalised_Interest*l.Percent_of_Project_Amt as Capitalised_Interest,
	   cdf.Capitalised_Fees*l.Percent_of_Project_Amt as Capitalised_Fees,
	   [Amt_cLiveCommitment]*l.Percent_of_Project_Amt as Amt_cLiveCommitment,
	   [Amt_cNonTriggeredCommitment]*l.Percent_of_Project_Amt as Amt_cNonTriggeredCommitment,
